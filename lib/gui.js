...
:root {
  ...
  --accent:#2563eb; --accent-2:#3b74f5; --on-accent:#fff; --accent-soft:#e7eefe;
  --ink:#1f2c31;
...
:root[data-theme="dark"] { color-scheme:dark;
  ...
  --accent:#6ea8fe; --accent-2:#86b7ff; --on-accent:#08183a; --accent-soft:#17233f;
  --ink:#cdd8d9;
...
.logo { width:32px; height:32px; flex:0 0 auto; display:block; }
.logo svg { width:100%; height:100%; display:block; border-radius:8px; box-shadow:0 2px 6px rgba(37,99,235,.4); }
.brand h1 {
...
<div class="app">
  <header class="topbar">
    <div class="brand">
      <span class="logo" id="logo"><svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><defs><linearGradient id="ctg" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#2f6bed"/><stop offset="1" stop-color="#1b4fd0"/></linearGradient></defs><rect x="92" y="92" width="840" height="840" rx="210" fill="url(#ctg)"/><path d="M452 430 532 512 690 336" fill="none" stroke="#fff" stroke-width="80" stroke-linecap="round" stroke-linejoin="round"/><path d="M492 600 648 756 M648 600 492 756" stroke="#fff" stroke-width="68" stroke-linecap="round" opacity=".92"/><polygon points="232,250 232,556 320,487 385,625 446,599 381,466 473,403" fill="#fff" stroke="#0c224e" stroke-width="26" stroke-linejoin="round" paint-order="stroke"/></svg></span>
